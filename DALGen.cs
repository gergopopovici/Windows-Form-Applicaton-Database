...
namespace adatbazis
{
    ...
    {
        //protected lathatosagi szabaly-csak a tartalmaz� oszt�lyb�l �s a sz�rmaztatott oszt�lyokban lehet haszn�lni
       ...
       //protected string strSqlConn = "Data Source=GERGO;Initial Catalog=etterem;Integrated Security=SSPI"; //Windows Authentication eset�n
        //protected string strSqlConn = "Data Source=(local);Initial Catalog=Berlesek;Integrated Security=SSPI";                                                                                                                        // protected string strSqlConn = "Data Source=ANDI-PC;Initial Catalog=Berles;Integrated Security=SSPI"; //Windows Authentication eset�n

        //SQL Server Authentication-nel valo kapcsolodas eseten:
        //protected string strSqlConn = "Data Source=(local);Initial Catalog=Berlesek;uid=andi;pwd=1234"; //SQL Server Authentication eset�n
        protected string strSqlConn = "Data Source=GERGO;Initial Catalog=etterem;uid=Gergo;pwd=Gergo"; 
        ...
        protected DataSet ExecuteDSParameterized(SqlCommand command, ref string errMess)
        {
            //letrehozunk egy Dataset objektumot-a parameter segitsegevel 
            //beallitottuk a DataSetName tulajdonsagat a DataSet objektumunknak
            DataSet dataSet = new DataSet();
        ...
        protected void ExecuteNonQueryParameterized(SqlCommand sqlCommand, ref string errMess)
        {
            try
            {
                OpenConnection(ref errMess);
        ...
        //ugyis megoldhato, hogy a SELECT-et tartalmazo string-et (query) es az SqlParameter tipusu objektumot adjuk at parameterkent
        //es akkor itt adjuk hozza az SqlCommand objektum parametereihez az SqlParameter tipusu objektumot

        /* 
        protected object ExecuteScalarUsingParametrizedQuery(string query, SqlParameter parameter, ref string errMess)
        {
            object value;
            try
            {
                ...
                //sqlCommand.CommandType = CommandType.Text; // ez az alapertelmezett
                value = sqlCommand.ExecuteScalar();
                errMess = "OK";
            }
            catch (SqlException e)
